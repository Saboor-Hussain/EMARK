...
<body>
	...
	%>
        ...
        <center>
            <h2 class="whiteTextColor" style="color: white;font-family: Arial, Helvetica, sans-serif;"> Deposit Money </h2>
    ...
    try {
        ...
        PreparedStatement pst = con.prepareStatement("SELECT * FROM transaction WHERE Name = ? And Type = 'Deposit' ORDER BY DateAndTime DESC");
